...
| 2026-08-23 | reorganize-flat-application-and-http-dir | Grouped catalog (27→5 folders) and identity (20→3) application layers; moved effective-permissions into packages/domain/rbac; rejected a locations context and a permissions service on dependency evidence |
