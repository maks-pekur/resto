...
- [ ] 08.5-01-PLAN.md — Backend owner-only gate primitive (@OwnerOnly decorator + OwnerOnlyGuard, 5th APP_GUARD) + guard-untouched regression (D-02/D-08/D-09)
- [ ] 08.5-02-PLAN.md — Backend session-pin cleanup: retire owner pin, 403 non-owner brand-switch, LOW-11 accept (D-13/D-14/D-15)
- [ ] 08.5-03-PLAN.md — `all` aggregate endpoint (@LocationNeutral @OwnerOnly, no-store, N/M badge) + owner single-location server validation (D-05/D-06/D-07/D-09/D-10/D-11/D-16)
