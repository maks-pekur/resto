...
const { ItemModifiersTabClient } =
  await import('../app/dashboard/(workspace)/menu/items/[id]/item-modifiers-tab-client');
...
describe('ItemModifiersTabClient (Plan 04b-08 Task 4)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
